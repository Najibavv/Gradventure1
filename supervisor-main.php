    ...
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              <li class="active"><a href="dashboard-my-ads.html"><i class="fa fa-user"></i> My Projects </a> </li>
              <li><a href="upload-project.php"> <i class="bi bi-folder-plus"></i> Upload New Projects <span>12</span></a></li>
			   <li><a href="#"><i class="bi bi-send-plus-fill"></i> Messages<span>0</span></a></li>
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        <!-- Recently Favorited -->
                ...
                <h3><i class="bi bi-bookmark-heart"></i> My Projects</h3>  
                  <br />   
		...
		$id=$_SESSION['USER_ID'];
			   ...
			   $query = "SELECT * FROM projects WHERE sid='$id'";
$result = $conn->query($query);
                while ($row = mysqli_fetch_assoc($result)){ 
                       myproject($row['id'], $row['pname'], $row['image'], $row['catagory'],$row['link']);      
                            } 
