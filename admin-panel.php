    ...
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-4 offset-lg-0">
        <div class="sidebar">
          ...
          <div class="widget user-dashboard-menu">
            <ul>
              <li class="active"><a href="dashboard-my-ads.html"> <i class="bi bi-journal-bookmark"></i> All Projects </a> </li>
            
			   <li><a href="dashboard-pending-ads.html"><i class="bi bi-envelope-fill"></i> Messages<span>2</span></a></li>
      ...
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-0">
        <!-- Recently Favorited -->
                ...
                <h3><i class="bi bi-bookmark-heart"></i> All Projects</h3>  
                  <br />   
