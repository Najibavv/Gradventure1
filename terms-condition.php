        ...
        <div class="row">
            <div class="col-lg-10 mx-auto p-0">
               <div class="terms-condition-content">
                <h3 class="py-3">Gradventure Terms & Condition</h3>
				<p><span class="font-weight-bold text-dark">This Privacy Statement describes how Gradventure Technology collects and safeguards your personal information.
If you have any questions that are not addressed in this policy, please contact us at privacy@gradventure.com.
When you interact with our products and services, we collect information from you in a variety of ways, as explained below.
By completing the account setup process on our website, you have consented to the collection and use of information as described in this Notice and agree to be bound by our Terms of Use.</p>
Please note that if you choose to invest in any offering advertised on our website, you may be required to agree to a separate agreement, including but not limited to new or expanded privacy notices or terms of service  </p
                ...
                <p><span class="font-weight-bold text-dark">• Log information:</span> We automatically collect information about the device you use to access the Service and your usage of the Service when you use it.
We may collect (where available) the type and model of device you use, the device's unique device identifier, operating system, browser type, language options, current time zone, and mobile network information to enable you to use the Service, for system administration purposes, and to report aggregated, anonymised data to our business partners. </p>
We do not use this information to determine an individual's name, address, or other personal information. </p>
			  </div>
            </div>
        </div>
    </div>
